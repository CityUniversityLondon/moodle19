...
if ($ADMIN->fulltree) {
    ...
    $helpbutton = helpbutton('security_realm', get_string('security_realm', 'block_echo360_configuration'), 'block_echo360_configuration', true, false, '', true);
    // Security Realm
    $settings->add(new admin_setting_configtext('block_echo360_configuration_security_realm', get_string('security_realm', 'block_echo360_configuration') . ' ' . $helpbutton, get_string('security_realm_description', 'block_echo360_configuration'), get_string('default_security_realm', 'block_echo360_configuration'), PARAM_TEXT));
    ...
    $options = array('shortname'=>get_string('shortname'), 'fullname'=>get_string('fullname'), 'idnumbercourse'=>get_string('idnumbercourse'), 'id'=>get_string('databaseid', 'block_echo360_configuration'));
