...
class block_sharing_cart extends block_base {
    ...
    function applicable_formats() {
        ...
        if (has_capability('block/sharing_cart:use', get_context_instance(CONTEXT_COURSE, $COURSE->id))) {
    ...
    function get_content() {
        ...
        $editing = isediting($this->instance->pageid) && has_capability('block/sharing_cart:use', $context);
        ...
        $tree = array();
        $dirs = array();
        if ($shared_items = get_records('sharing_cart', 'sc_user', $USER->id)) {
