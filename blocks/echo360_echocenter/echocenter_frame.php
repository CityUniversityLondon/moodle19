 ...
 */
    ...
    $meta = "";
    $meta .= '<link rel="stylesheet" type="text/css" href="' . $CFG->wwwroot . '/blocks/echo360_echocenter/styles.css"/>';
    ...
    print_header("$COURSE->shortname: $echocenter_str", $COURSE->fullname, $navigation, '', $meta);
    print_heading(format_string($COURSE->fullname) . ": $echocenter_str", '', 3);
