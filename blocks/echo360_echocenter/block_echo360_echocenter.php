...
class block_echo360_echocenter extends block_base {
    ...
    function get_content() {
        ...
        $this->content->text = '<div class="block_echo360_echocenter"><center><a href="' . $CFG->wwwroot . '/blocks/echo360_echocenter/echocenter_frame.php?id=' . $COURSE->id . '"><img src="'. $CFG->wwwroot .'/blocks/echo360_echocenter/pix/echo360_logo_160x60.png" border="0" alt="Echo360"/><br/>' . get_string('echocenter_link', 'block_echo360_echocenter') . '</a></center></div>';
        $this->content->footer = '';
        return $this->content;
    }
