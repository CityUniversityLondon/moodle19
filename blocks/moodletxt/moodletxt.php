<?php
    ...
    */
    ...
    // Figure out whether to display a course link in the menu
    if (is_object($course) && $course->id > 0) {

        print_header($title, $heading, '<a href="' . $CFG->wwwroot . '/course/view.php?id=' . $course->id . '">' . $course->shortname . '</a> -> ' . $blocktitle, '', false, '&nbsp;');
