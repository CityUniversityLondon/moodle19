    ...
    <h2 style="margin-top:2em;">Account Details</h2>
        <form action="<?php echo($ME); ?>" method="post">
            ...
            <fieldset>
                ...
                <?php echo(moodletxt_vomit_errors(array('addNoAccountName', 'addNoPassword', 'addNoMatch', 'addExists', '401', '403', '404', '500', '503', '600', 'invalidaccount', 'addNotInserted'), $errorArray)); ?>
