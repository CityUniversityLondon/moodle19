<?php
    ...
    */
    ...
    if ($course->id > 0) {
        ...
        print_header($title . ' ' . $addressbook->name, $heading, '<a href="' . $CFG->wwwroot . '/course/view.php?id=' . $course->id . '">' . $course->shortname . '</a> -> <a href="moodletxt.php">' . $blocktitle . '</a> -> <a href="' . $CFG->wwwroot . '/blocks/moodletxt/addressbooks.php">' . $parentheader . '</a> -> ' . $heading, '', '', false, '&nbsp;');

    } else {

        print_header($title . ' ' . $addressbook->name, $heading, '<a href="moodletxt.php">' . $blocktitle . '</a> -> <a href="' . $CFG->wwwroot . '/blocks/moodletxt/addressbooks.php">' . $parentheader . '</a> -> ' . $heading, '', '', false, '&nbsp;');
