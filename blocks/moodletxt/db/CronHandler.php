...
class CronHandler {
    ...
    function doCron() {
        ...
        mtrace('');
        mtrace('calling getStatusUpdates');
        $this->getStatusUpdates();
        mtrace('calling getInboundMessages');
        $this->getInboundMessages();
        mtrace('calling updateAccountDetails');
         ...
         */
        //if (rand(1, 6) == 1)
            mtrace('calling removeDeadAddressbookLinks');
            $this->removeDeadAddressbookLinks();

        //if (rand(1, 6) == 1)
            mtrace('calling removeDeadInboxMessageLinks');
            $this->removeDeadInboxMessageLinks();

        //if (rand(1, 6) == 1)
            mtrace('calling removeDeadSentMessageLinks');
            $this->removeDeadSentMessageLinks();

        mtrace('Moodletxt cron finished');
        return true;
    ...
    function getStatusUpdates() {
        ...
        foreach($outboundaccounts as $account) {
            ...
            */
            ...
            mtrace("crongetfinishedmessages: $sql");
    ...
    function removeDeadAddressbookLinks() {
        ...
        mtrace("crondeadaddressbooklinks: $sql");
