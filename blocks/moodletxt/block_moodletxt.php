<?php
    ...
    class block_moodletxt extends block_base {
        ...
        function get_content() {
            ...
            $this->content->text .= ($numberOfAccounts > 0 && $canViewStats) ? '<a href="' . $CFG->wwwroot . '/blocks/moodletxt/userstats.php">' . get_string('blocklink6', 'block_moodletxt') . '</a><br />' : '';
