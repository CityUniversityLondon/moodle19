<?php
    ...
    class moodletxt_connector {
         ...
         * @var string
         */
        var $USER_AGENT = 'Moodletxt 2.4-beta2 (2011011101)';
        ...
        function send_request($xmlrequests) {
            ...
            foreach($xmlrequests as $xmlrequest) {
                ...
                $request  = "POST " . $fullPath . " HTTP/1.1\r\n";
    ...
    <Error>
        ...
        function get_feed() {
            ...
            // Set defaults
            $pathPrefix = "http://";
            $txttoolsHost = 'www.moodletxt.co.uk';
            $txttoolsPath = 'www.moodletxt.co.uk/rss.xml';
            $connectionHost = $txttoolsHost;
            $connectionPort = 80;
            ...
            // Build connection string
            $request  = "GET " . $pathPrefix . $txttoolsPath . " HTTP/1.1\r\n";
            $request .= "Host: " . $txttoolsHost . "\r\n";
            $request .= "User-Agent: " . $this->USER_AGENT . "\r\n";
            if ($proxyHost != '' && $proxyPort != '') {
