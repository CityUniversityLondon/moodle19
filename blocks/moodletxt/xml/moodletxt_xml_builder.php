<?php
    ...
    class moodletxt_xml_builder {
         ...
         * Temporarily reduced in 2.3.3 to counter txttools bug.
         * @var int
         */
        var $MAX_BLOCKS_PER_REQUEST = 15;
        ...
        function build_outbound_authentication ($txttoolsaccount) {
            ...
            $accountobject->password = $encrypt_o_matic->decrypt($key, $accountobject->password);
    ...
    <Authentication>
        ...
        <Password><![CDATA[' . $accountobject->password . ']]></Password>
    </Authentication>';
...
<Request>
	...
	<GetMessagesUsed>
        ...
        function build_inbound_authentication($useraccount) {
            ...
            // Get EK
            $key = moodletxt_get_setting('EK');
            $useraccount->password = $encrypt_o_matic->decrypt($key, $useraccount->password);
            unset($encrypt_o_matic);
    ...
    <Authentication>
        ...
        <Password><![CDATA[' . $useraccount->password . ']]></Password>
    </Authentication>';
