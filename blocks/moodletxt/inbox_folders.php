<?php
    ...
    */
    ...
    if ($course->id > 0) {
        ...
        print_header($title . ' ' . $USER->username, $heading, '<a href="' . $CFG->wwwroot . '/course/view.php?id=' . $course->id . '">' . $course->shortname . '</a> -> <a href="moodletxt.php?courseid=' . $course->id . '">' . $blocktitle . '</a> -> <a href="inbox.php?courseid=' . $course->id . '">' . $inboxtitle . '</a> -> ' . $heading, '', '', false, '&nbsp;');

    } else {

        print_header($title . ' ' . $USER->username, $heading, '<a href="moodletxt.php">' . $blocktitle . '</a> -> <a href="inbox.php">' . $inboxtitle . '</a> -> ' . $heading, '', '', false, '&nbsp;');
