...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $ADMIN->add('unsupported', new admin_externalpage('cul_rebuildcoursecache', 'Rebuild course cache', $CFG->wwwroot.'/'.$CFG->admin.'/cul_rebuildcoursecache.php', 'moodle/site:config', true));
