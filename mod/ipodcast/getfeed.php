...
\******************************************************************************/
    ...
    $relativepath = get_file_argument('getfeed.php');
    ...
    add_to_log($courseid, "ipodcast", "get rss feed", "index.php?id=$courseid", $filename, 0,$userid);

    if(!$result = ipodcast_build_feeds($courseid,$userid)) {
        not_found();
	}	
