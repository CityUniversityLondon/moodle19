<?php  // $Id: lib.php,v 1.20.2.8 2009/03/17 08:30:11 joseph_rezeau Exp $
...
//See other modules as example.
    ...
    //Get students
    $users = get_records_sql('SELECT DISTINCT u.id, u.username, u.idnumber, u.email, u.firstname, u.lastname, TO_CHAR(u.description), u.picture '.
