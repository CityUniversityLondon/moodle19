...
$string['groupchoice:choose'] = 'Select a group';
$string['groupchoice:deleteresponses'] = 'Delete responses';
$string['groupchoice:downloadresponses'] = 'Download responses';
$string['groupchoice:readresponses'] = 'Read responses';
...
$string['choicesaved'] = 'Your group selection has been made';
$string['deleteattemptcheck'] = 'Are you absolutely sure you want to completely delete these group choices?';
