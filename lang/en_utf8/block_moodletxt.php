...
$string['blocktitle']                   = 'Moodletxt';
$string['blocklink1']                   = 'Send a Text';
$string['blocklink2']                   = 'View Sent Messages';
$string['blocklink3']                   = 'Manage Address Book';
$string['blocklink4']                   = 'View Received Messages';
$string['blocklink5']                   = 'Change your Settings';
$string['blocklink6']                   = 'View user stats';
$string['blocklink7']                   = 'Change Admin Options';
$string['blockfooter']                  = 'Powered by <a href    =\"http://www.txttools.co.uk\">txttools.co.uk</a>';
...
$string['sendbutadd']                   = 'Add';
$string['sendbutrem']                   = 'Remove';
$string['sendbuttag1']                  = 'First Name';
$string['sendbuttag2']                  = 'Last Name';
$string['sendbuttag3']                  = 'Full Name';
$string['sendconfirmcharacters']        = 'characters';
$string['sendconfirmmessage']           = 'Message:';
$string['sendconfirmrecipients']        = 'Recipients:';
...
$string['sendheaderrecipients']         = 'Message Recipients';
$string['sendheaderslide1']             = 'Select Recipients';
$string['sendheaderslide2']             = 'Compose Message';
$string['sendheaderslide3']             = 'Message Options';
$string['sendheaderslide4']             = 'Review and Send';
...
$string['sendlabelaccount']             = 'txttools account:';
$string['sendlabelaccountdesc']         = 'Account description:';
$string['sendlabeladditional']          = 'Enter number here (eg +44123456789):';
$string['sendlabeladditionalname']      = 'Enter first name/last name:';
$string['sendlabeladdresscontacts']     = 'Address Book Contacts:';
$string['sendlabeladdressgroups']       = 'Address Book Groups:';
$string['sendlabeladdsig']              = 'Add signature:';
$string['sendlabelcharsused']           = 'Characters used:';
...
$string['sendlabelnametags']            = 'Insert into the message:';
$string['sendlabelnotemplates']         = 'No templates found';
$string['sendlabelrecipienttype']       = 'Choose...';
$string['sendlabelschedule']            = 'Schedule for';
$string['sendlabelschedulefrag']        = 'at';
$string['sendlabelselecttemplate']      = 'Choose a template...';
$string['sendlabelsendnow']             = 'Send now';
$string['sendlabelservertime']          = 'Current server time is';
$string['sendlabelsuppressno']          = 'Send full unicode messages (default - messages containing non-GSM characters are restricted to 70 characters)';
$string['sendlabelsuppressyes']         = 'Restrict message to GSM character set only (all messages are 160 characters long)';
$string['sendlabeltemplates']           = 'Templates';
$string['sendlabelusergroups']          = 'Moodle User Groups:';
$string['sendlabeluserlist']            = 'Moodle Users:';
$string['sendlegendaccounts']           = 'txttools Accounts';
$string['sendlegendschedule']           = 'Scheduling';
$string['sendlegendunicode']            = 'Unicode Messaging Options';
$string['sendmultipleaccounts']         = 'You may have access to more than one txttools account on this course.  Please select which one to use when sending this text message.';
$string['sendnavmenu1']                 = 'Step 1: Select recipients';
$string['sendnavmenu2']                 = 'Step 2: Compose message';
$string['sendnavmenu3']                 = 'Step 3: Message Options';
$string['sendnavmenu4']                 = 'Step 4: Review &amp; Send';
...
$string['historytitle']                 = 'moodletxt History for';
$string['historyview']                  = 'View moodletxt History';
...
$string['senttableheaderuser']          = 'User Account';
$string['senttableheaderacc']           = 'txttools Account';
$string['senttableheadermessage']       = 'Message Text';
$string['senttableheadertime']          = 'Time Sent';

// View Message Page

$string['messageviewtitle']             = 'Viewing a Message in';
$string['messageview']                  = 'View Sent Message';

$string['viewheadercurrentstatus']      = 'Current Status';
$string['viewheadermessagedetails']     = 'Message Details';
$string['viewheaderstatuskey']          = 'Status Key';
$string['viewlabelauthor']              = 'Message Author:';
$string['viewlabelmessagetext']         = 'Message Text:';
$string['viewlabelscheduled']           = 'Scheduled For:';
$string['viewlabeltimesent']            = 'TimeSent:';
$string['viewtableheaderuser']          = 'Recipient';
$string['viewtableheaderphone']         = 'Sent to Number';
$string['viewtableheadertime']          = 'Time of Update';
$string['viewtableheaderstatus']        = 'Message Status';
$string['viewunknownlink']              = 'Unknown';

// Inbox page

$string['inboxtitle']                   = 'moodletxt Inbox for';
$string['inboxheader']                  = 'Your Received Messages';
...
$string['statuskeyfailed']              = 'Message delivery has failed and will not be delivered to the mobile phone.';
$string['statuskeyfailedalt']           = 'Failed';
$string['statuskeyfailedtitle']         = 'Delivery has failed';
$string['statuskeysent']                = 'Message has been sent. No errors or handset delivery confirmation received.';
$string['statuskeysentalt']             = 'Sent';
$string['statuskeysenttitle']           = 'Message sent, but not yet confirmed';
$string['statuskeyreceived']            = 'Message delivery confirmed as received by the mobile phone.';
...
$string['settingsbuttemplatedel']       = 'Delete Template';
$string['settingsbuttemplateedit']      = 'Edit Template';
$string['settingscharsremain']          = 'Characters remaining:';
$string['settingsedittemplate']         = 'Update Template';
$string['settingstitle']                = 'Changing Settings';
$string['settingstitlein']              = 'Changing settings in';
$string['settingsheading']              = 'Change Settings';
$string['settingsinboxlink']            = 'Go to your inbox';
$string['settingslegendedittemplate']   = 'Edit Existing Template';
$string['settingsnotemplateselected']   = 'Please select a template to edit.';
$string['settingssendtextlink']         = 'Send a text message from';
$string['settingssentmessageslink']     = 'View your sent messages';
$string['settingstemplateheader']       = 'My Message Templates';
$string['settingssigheader']            = 'My Signature';
$string['settingssigupdated']           = 'Signature has been saved.';
$string['settingssubmitsignature']      = 'Update Signature';
$string['settingssubmittemplate']       = 'Add Template';
$string['settingstemplateadded']        = 'The template was added to the system.';
$string['settingstemplateaddleg']       = 'Add New Template';
$string['settingstemplatedeleted']      = 'The template was deleted successfully.';
$string['settingstemplateeditleg']      = 'Existing Templates';
$string['settingstemplateupdated']      = 'The template was successfully updated.';
...
$string['adminheaderaccounts']          = 'txttools Accounts';
...
$string['adminheadersettings']          = 'System Settings';
...
$string['admininfocontactweb']          = 'Visit txttools.co.uk';
$string['admininfoheader1']             = 'Automatically Updating Status Information';
$string['admininfoheader2']             = 'txttools contact information';
$string['admininfopara1']               = 'If your Moodle system can accept incoming connections from outside your institution on port 443 (HTTPS),then by providing txttools with some basic connection info, you can have status updates and inbound messages automatically sent to your moodletxt installation.  This will provide you with instantly up-to-date information, without requiring you to fetch it manually.';
$string['admininfopara2']               = 'To use XML push facilities, you need to create a username and password for the txttools system to use when connecting. Use the form at the top right of the page to store these details, then contact txttools support with the username, password, and the address shown below.  Once this is done you can disable automatic fetching in the system settings - again, using the form at the top right.';
...
$string['admininfopara5']               = 'If you have any questions regarding the txttools system, or need help using the moodletxt system, feel free to contact the txttools support team via any of the methods shown below.';
$string['adminintroheader1']            = 'No txttools Accounts Found';
$string['adminintroheader2']            = 'Users with existing txttools accounts';
$string['adminintroheader3']            = 'Users without existing txttools accounts';
$string['adminintropara1']              = 'You are most likely seeing this message because you have just installed moodletxt.  moodletxt requires at least one txttools.co.uk account to be registered on the moodletxt system in order to run.';
$string['adminintropara2']              = 'Users with existing txttools accounts should first make sure that any account they wish to use with the moodletxt system has been enabled.  You can do this by contacting txttools at <a href    =\"mailto:support@txttools.co.uk\">support@txttools.co.uk</a>, or by phone on +44 (0) 113 234 2111.  Activation takes just a few minutes.';
...
$string['adminintropara4']              = 'If you do not already have a txttools account registered, you can obtain one by contacting txttools at <a href    =\"mailto:sales@txttools.co.uk\">sales@txttools.co.uk</a>, or by phone on +44 (0) 113 234 2111.  <b>Remember to mention that you will be using the account with moodletxt, so that your account can be activated for use with it.</b>';
$string['adminintropara5']              = 'Once you have obtained a txttools account, please enter its details into the form below.  This will activate moodletxt, and you will be immediately able to use the system.';
...
$string['adminlabeldisablewarn']        = 'Disable SSL security warning.';
$string['adminlabelexistingacc']        = 'Available txttools accounts:';
...
$string['adminlabelproxysettings']      = 'Proxy Settings:';
...
$string['adminlabelselectacc']          = 'Select a txttools account...';
...
$string['adminlabelshowinbound']        = 'Show source names/numbers in inbox';
$string['adminlabelshowproxy']          = 'Show proxy settings';
$string['adminlinkaccounts']            = 'View Full Account Listings';
$string['adminlinkuserstats']           = 'View User Statistics';
...
$string['adminsslfailedpara1']          = 'While testing your system for compatibility, moodletxt was unable to establish a secure connection with the txttools server.  This may be due to a network problem, or your server may not be configured for use with Secure Socket Layer (SSL) connections.';
...
$string['admintitle']                   = 'Admin Options';
$string['admintitlein']                 = 'Admin Options in';

// Account listing page

$string['adminaccountbutupdateall']     = 'Update Credit Info For All Accounts';
$string['adminaccountconfirmupdate']    = 'moodletxt will now connect to the txttools server and poll each registered account for updated data. If you have a large number of txttools accounts registered in moodletxt then this can take a significant amount of time. Do you wish to continue?';
$string['adminaccountfragdenied']       = 'Access Denied';
$string['adminaccountfraginbound']      = 'Inbound Active';
$string['adminaccountfragloading']      = 'Updating account...';
$string['adminaccountfragoutbound']     = 'Outbound Active';
$string['adminaccountsheading']         = 'txttools Account List';
$string['adminaccountintropara1']       = 'This page displays details of all the txttools accounts registered within the system.  To enable or disable inbound/outbound access on a given account, find the account\'s entry in the table below, and click the appropriate icon.  This will toggle access as required.';
$string['adminaccountintropara2']       = 'Clicking the \"Update Credit Info\" button will synchronise credit information for the accounts listed with the txttools server.  Please note that this task is normally taken care of at regular intervals by the Moodle system, and as such is not normally necessary';
$string['adminaccountinvoicedaccount']  = 'Invoiced account';
$string['adminaccountprocessedfrag']    = 'Processed';
$string['adminaccountstitle']           = 'Account List';
$string['adminaccountupdatefailed']     = 'Update error';
$string['adminaccountupdatesuccess']    = 'Updated OK';

$string['acctableheaderallowinbound']   = 'Allow Inbound';
$string['acctableheaderallowoutbound']  = 'Allow Outbound';
$string['acctableheadercreditsleft']    = 'Credits Remaining';
$string['acctableheadercreditsused']    = 'Total Credits Used';
$string['acctableheaderdescription']    = 'Description';
$string['acctableheaderlastupdate']     = 'Last Credit Update';
$string['acctableheadermessages']       = 'Messages Sent From moodletxt';
$string['acctableheaderusername']       = 'txttools Username';

// XML parser

$string['parserinvalidlogin']           = 'The txttools account details used are invalid.  Either the username or password entered are invalid, or the account selected has not been enabled for use with moodletxt.  Please check your txttools account details and try again.  If you still encounter problems, please contact txttools to make sure your account has been activated.';
$string['parserinvalidxml']             = 'The connection to the txttools system was rejected because the data sent was invalid.  You may be using a version of moodletxt that is out of date.  Please contact txttools.co.uk for more information.';
...
$string['errorbadmessageid']            = 'The message ID given does not exist. Please select a valid message to view.';
$string['errorbadvkey']                 = 'Form validation key invalid.  Form hacking detected.  Aborting form processing.';
...
$string['errorconn401']                 = 'Moodletxt was not granted access to the txttools.co.uk system. Reason unknown. This is not a user authentication error. HTTP error code: ';
$string['errorconn404']                 = 'Moodletxt could not find the XML connector on the txttools server. This may be due to a temporary loss of service, or your Moodletxt version may be out of date.  Please contact txttools support for more information.';
$string['errorconn500']                 = 'There was an internal error on the txttools server that prevented the XML request from being processed.  This error should be temporary.  Please contact txttools support for more information.';
$string['errorconn503']                 = 'The txttools XML service is currently unavailable.  Please try again later.  If the problem persists, please contact txttools support.';
$string['errorconndefault']             = 'An error occurred when attempting to contact the txttools XML connector service.  The HTTP response code was: ';
$string['errorconnnosocket']            = 'XML connector error: Could not open socket to txttools. Please ensure your moodletxt installation has outbound access through your firewall.';
...
$string['errorconnrss404']              = 'Moodletxt could not find the RSS feed on the moodletxt server. This may be due to a temporary loss of service, or your moodletxt version may be out of date.  Please contact txttools support for more information.';
$string['errorconnrss500']              = 'There was an internal error on the txttools server that prevented the feed request from being processed.  This error should be temporary.  Please contact txttools support for more information.';
$string['errorconnrss503']              = 'The txttools RSS service is currently unavailable.  Please try again later.  If the problem persists, please contact txttools support.';
...
$string['errorfilterbadphoneno']        = 'The phone number you entered was invalid. Please enter a valid phone number to filter messages against.';
...
$string['errorformhackaccount']         = 'Form hacking detected.  You are not authorised to use the txttools account selected.';
...
$string['errorinboxcantconnect']        = 'One or more of your txttools accounts could not connect to check for new messages.  Please ask an administrator to check your account details in the moodletxt control panel.';
...
$string['errornoaccountselected']       = 'No txttools account was selected to send the message from.';
$string['errornoaccountspresent']       = 'This page cannot be used until txttools accounts are registered within the moodletxt system. Please contact your system administrator.';
...
$string['errornopassword']              = 'No password was entered for the txttools account.';
...
$string['errornotemplate']              = 'You must enter a template into the textbox below in order to add it to the system.';
$string['errornousername']              = 'No username was entered for the txttools account.';
...
$string['errorsigupdatefail']           = 'Signature could not be updated.  Please try again later.';
