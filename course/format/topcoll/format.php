...
// CMDL-1358 - Wrapped each row in tbody tags and gave this the section-<n> id
// Changed existing tr tag id from section-<n> to sectionbody-<n>
// This then allowed the js code (modified functions in /lib/ajax/section_classes_coll_top.js)
// to move the topic header with the topic body.
...
<script type="text/javascript" src="<?php echo $CFG->wwwroot ?>/lib/ajax/section_classes_coll_top.js"></script>
...
/// Print Section 0
    ...
    if ($thissection->summary or $thissection->sequence or isediting($course->id)) {
        echo '<tbody id="section-0" class="cps">';
        echo '<tr id="sectionhead-0" class="cps"></tr>';
        echo '<tr id="sectionbody-0" class="section main">';
...
/// Everything below uses "section" terminology - each "section" is a topic.
    ...
    while ($section <= $course->numsections) {
        ...
        if ($showsection) {
            ...
            echo '<tbody id="section-'.$section.'" class="cps">';
            ...
            echo '<tr id="sectionbody-'.$section.'" class="section main'.$sectionstyle.' hid">';
