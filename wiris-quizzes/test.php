...
function wrsqz_testGetVars(){
  ...
  '<command><input><math xmlns="http://www.w3.org/1998/Math/MathML"><mi>c</mi>'.
  '<mo>=</mo><mi>θ</mi></math></input></command>'.
  '</group></library></session>';
	...
	}else if($result['vars']['##Tc']!='θ'){
    $ok = false;
    $message = 'Error with UTF-8 characters. If you have your PHP configured with <strong>--with-curlwrappers</strong> then try to switch to PHP 4 compatibility mode.';
  }
